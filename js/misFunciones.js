...
function traerInformacionCabañas(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Cabin/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCabañas(){
    let var3 = {
        ...
        url:"http://129.151.110.49:8080/api/Cabin/save",
...
function editarInformacionCB(){
    ...
    $.ajax({
        url:"http://129.151.110.49:8080/api/Cabin/update",
        type:"PUT",
        data:dataToSend,
...
function borrarElementoCB(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Cabin/'+idElemento,
        type:"DELETE",
...
function traerInformacionCategorias(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionCategorias(){
    let var4 = {
        ...
        url:"http://129.151.110.49:8080/api/Category/save",
...
function editarInformacionCT(){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.110.49:8080/api/Category/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoCT(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Category/'+idElemento,
        type:"DELETE",
...
function traerInformacionClientes(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionClientes(){
    let var4 = {
        ...
        url:"http://129.151.110.49:8080/api/Client/save",
...
function editarInformacionCL(){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.110.49:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoCL(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Client/'+idElemento,
        type:"DELETE",
...
function traerInformacionMensajes(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMensajes(){
    let var4 = {
        ...
        url:"http://129.151.110.49:8080/api/Message/save",
...
function editarInformacionME(){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.110.49:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoME(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Message/'+idElemento,
        type:"DELETE",
...
function traerInformacionReservaciones(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionReservaciones(){
    let var4 = {
        ...
        url:"http://129.151.110.49:8080/api/Reservation/save",
...
function editarInformacionRE(){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.110.49:8080/api/Reservation/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoRE(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Reservation/'+idElemento,
        type:"DELETE",
...
function traerInformacionAdmin(){
    $.ajax({
        url:"http://129.151.110.49:8080/api/Admin/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionAdmin(){
    let var4 = {
        ...
        url:"http://129.151.110.49:8080/api/Admin/save",
...
function editarInformacionAD(){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.110.49:8080/api/Admin/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElementoAD(idElemento){
    ...
    $.ajax({
        ...
        url:'http://129.151.110.49:8080/api/Admin/'+idElemento,
        type:"DELETE",
